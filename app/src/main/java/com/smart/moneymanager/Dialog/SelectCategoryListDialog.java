...
import com.smart.moneymanager.ListAdaptor.SelectCategoryListAdaptor;
       ...
       // Button cancleButton = (Button) dialog.findViewById(R.id.btnCancel);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 NavHostFragment hff =  (NavHostFragment) ((ActivityBottomNavig)context).getSupportFragmentManager().findFragmentById(R.id.nav_host_fragment);
