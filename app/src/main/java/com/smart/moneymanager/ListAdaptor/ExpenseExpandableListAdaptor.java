...
public class ExpenseExpandableListAdaptor extends BaseExpandableListAdapter {
    ...
    public  ExpenseExpandableListAdaptor(Context context, List<DayTransactions> DayExpenseList){
        ...
        categories = ActivityStart.getDBInstance(context).mmDao().GetCategories();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.parent_horizontal_list, null);
        }
...
//                                                ActivityStart.getDBInstance(context).mmDao().DeleteTransaction(DayExpenseList.get(gp).getDayTransactionList().get(cp));
//                                                ActivityStart.destroyDBInstance();
