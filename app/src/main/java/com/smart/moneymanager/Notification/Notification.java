package com.smart.moneymanager.Notification;
...
public class Notification extends BroadcastReceiver {
    ...
    private void CreateMonthlyNotification(Context context) {
        PendingIntent notificationIntent = PendingIntent.getActivity(context, 0, new Intent(context, ActivityBottomNavig.class),0);
    ...
    private void CreateDailyNotification(Context context, String header, String message, String alert) {
        PendingIntent notificationIntent = PendingIntent.getActivity(context, 0, new Intent(context, ActivityAddTrans.class),0);
        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        NotificationCompat.Builder builder = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
