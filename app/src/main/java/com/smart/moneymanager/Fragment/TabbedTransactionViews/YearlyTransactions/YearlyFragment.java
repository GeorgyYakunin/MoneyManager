package com.smart.moneymanager.Fragment.TabbedTransactionViews.YearlyTransactions;
...
import com.smart.moneymanager.Entity.YearlyTransactions;
...
import com.smart.moneymanager.ListAdaptor.YearlyExpenseExpandableListAdaptor;
...
public class YearlyFragment extends Fragment implements ITabbedFragments {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ((ActivityBottomNavig)getActivity()).setHeaderText(getResources().getString(R.string.yearly));
