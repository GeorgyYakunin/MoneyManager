...
import com.smart.moneymanager.ListAdaptor.DayTransactionsRecycleViewAdaptor;
...
public class ActivityDailyTrans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_daily_trans);
        ...
        allCategories = ActivityStart.getDBInstance(getApplicationContext()).mmDao().GetCategories();
    ...
    private void LoadTransactions(){
        ...
        dayTransactions = ActivityStart.getDBInstance(getApplicationContext()).mmDao().GetTransactionsOfaDate(date);
        ActivityStart.destroyDBInstance();
