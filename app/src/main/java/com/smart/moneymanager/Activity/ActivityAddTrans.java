...
import com.smart.moneymanager.ListAdaptor.CategoryListAdaptor;
...
public class ActivityAddTrans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_add_trans);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if(transactionId == 0){
                        ActivityStart.getDBInstance(getApplicationContext()).mmDao().AddTransaction(newTransaction);
                        ActivityStart.destroyDBInstance();
                        Toast.makeText(getApplicationContext(),"Saved Successfully",Toast.LENGTH_LONG).show();
                    }
                    if(transactionId != 0){
                        newTransaction.setId(transactionId);
                        ActivityStart.getDBInstance(getApplicationContext()).mmDao().UpdateTransaction(newTransaction);
                        ActivityStart.destroyDBInstance();
        ...
        if(transactionId != 0){
            ...
            Transaction transaction = ActivityStart.getDBInstance(getApplicationContext()).mmDao().GetTransactionById(transactionId);
            ActivityStart.destroyDBInstance();
    ...
    public void LoadCategory(long selectedId){
        List<Category> categories = ActivityStart.getDBInstance(this).mmDao().GetCategoriesofType(isIncome);
        ActivityStart.destroyDBInstance();
...
//
//        ArrayAdapter<CharSequence> mSpinnerAdapter = ArrayAdapter.createFromResource(this, R.array.dropdown_income_expense, R.layout.item_spinner);
//        mSpinnerAdapter.setDropDownViewResource(R.layout.item_simple_spinner);
