...
import com.smart.moneymanager.ListAdaptor.FileExplorerRecyclerViewAdapter;
...
public class ActivityFileExp extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_file_exp);
        ...
        tvBarText.setText("@string/import_txt");
        ivBarLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), ActivityExportImport.class));
    ...
    private void getDir(String dirPath) {
        ...
        //ArrayAdapter<String> fileList = new ArrayAdapter<String>(this, R.layout.row_file, item);
    ...
    public void onListItemClick(int position) {
        ...
        if (file.isDirectory()) {
            ...
            if(ImportExport.importDB(path.get(position).substring(Environment.getExternalStorageDirectory().toString().length()), getApplicationContext())){
                startActivity(new Intent(getApplicationContext(), ActivityExportImport.class).putExtra("isImport","success"));

            }else {
                startActivity(new Intent(getApplicationContext(), ActivityExportImport.class).putExtra("isImport","failed"));
            }
